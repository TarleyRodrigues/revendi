...
export function MetricCard({
  ...
  trend, trendValue, color = 'emerald',
}: MetricCardProps) {
  return (
    <div className="bg-white rounded-2xl p-4 border border-zinc-100 shadow-sm">
      <div className="flex items-start justify-between mb-3 gap-2">
        {/* gap-2 + flex-shrink-0 no ícone evitam quebra de linha no título */}
        <p className="text-xs font-medium text-zinc-500 uppercase tracking-wide leading-tight">
          {title}
        </p>
        <div className={cn(
